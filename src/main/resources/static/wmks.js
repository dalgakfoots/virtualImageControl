(function () {
    ...
    function f(d) {
        ...
        (f._receiveQueueBytesUnread = function () {
                ...
                while (g < this._legacyReceiveQueueIndex + a)
                    (b = this._legacyReceiveQueue.charCodeAt(g)),
                        b < 128
                            ? (f.push(b), g++)
                            : b < 224
                            ? ((c = this._legacyReceiveQueue.charCodeAt(g + 1) & 63), f.push(((b & 31) << 6) | c), (g += 2))
                            : b < 240
                            ? ((c = this._legacyReceiveQueue.charCodeAt(g + 1) & 63), (d = this._legacyReceiveQueue.charCodeAt(g + 2) & 63), f.push(((b & 15) << 12) | (c << 6) | d), (g += 3))
            ...
            (f._readTightData = function (a) {
                ...
                this._useImageBitmaps
                    ...
                    : ((a.image = this._imageManager.getImage()),
                      ...
                      (a.image.destY = a.y),
                      f
                          ? ((e = b(e, !0)), (a.image.onload = this.onDecodeObjectURLComplete), (a.image.src = f.createObjectURL(new Blob([e], { type: d }))))
                          : ((e = c.encodeFromString(e)), (a.image.onload = this.onDecodeComplete), (a.image.src = "data:" + d + ";base64," + e))),
                    this._nextRect();
            }),
            ...
            (e.wsOpen = function (a) {
                ...
                this.protocol === "vmware-vvc" && (e._setupVVC(), WMKS.LOGGER.log("WebSocket is using VMware Virtual Channels"), (this.protocol = "binary")),
                    this.protocol === "binary" && ((this.binaryType = "arraybuffer"), WMKS.LOGGER.log("WebSocket HAS binary support")),
    ...
    (WMKS = {}),
        ...
        (WMKS.BROWSER = new (function () {
            ...
            (this.isIE = a.indexOf("msie") !== -1 || a.indexOf("trident") !== -1 || a.indexOf("edge") !== -1 ? c : d),
                ...
                !this.isIE() &&
                    ...
                    ((this.isWebkit = c), a.indexOf("chrome") !== -1 ? (this.isChrome = c) : a.indexOf("bb") !== -1 ? (this.isBB = c) : a.indexOf("safari") !== -1 && (this.isSafari = c)),
                ...
                (this.hasTouchInput = "ontouchstart" in window || navigator.maxTouchPoints || navigator.msMaxTouchPoints ? c : d),
            ...
            (this.version = { full: "" }),
                this.isSafari()
                    ...
                    : this.isOpera()
                    ? (this.version.full = e(/Version[ \/]([0-9\.]+)/i, 1) || e(/(?:opera|opr)[\s\/]([0-9\.]+)/i, 1))
                    : this.isIE() && (this.version.full = e(/(?:\b(MS)?IE\s+|\bTrident\/7\.0;.*\s+rv:|\bEdge\/)([0-9\.]+)/i, 2));
        ...
        (WMKS.CONST = { CLICK: { left: 1, middle: 2, right: 4 }, FORCE_RAW_KEY_CODE: { 8: !0, 9: !0, 13: !0 } }),
        (WMKS.UTIL = {
        ...
        (e.prototype._onMediaSourceOpen = function (a) {
            ...
            (this._sourceBuffer = this._mediaSource.addSourceBuffer(e.byteStreamFormat)),
                this._sourceBuffer.addEventListener("updateend", function () {
                    ...
                    b._tempQueue[0].method === "add" && b._decodeDoneCb && (b._doneRequest++, WMKS.LOGGER.debug(b + " request track: send " + b._sendRequest + " done " + b._doneRequest), b._decodeDoneCb()),
                        b._tempQueue.shift(),
                        b._flushPayloads();
                }),
                ...
                try {
                    if (this._tempQueue[0].method === "add") this._sourceBuffer.appendBuffer(this._tempQueue[0].payload);
                        ...
                        (a = this._sourceBuffer.buffered.start(0)),
                            ...
                            WMKS.LOGGER.log(this + " status:  start " + a + " end " + b + " with current time " + this._mediaPlayer.currentTime);
                    ...
                    if (d.name === "QuotaExceededError") {
                        ...
                        WMKS.LOGGER.error(this + " encounters a unrecoverable error. " + d),
                            ...
                            this._decodeErrorCb && !this._isErrorDoneCalled && ((this._isErrorDoneCalled = !0), this._decodeErrorCb());
                }
        }),
        (e.prototype.reset = function () {
            WMKS.LOGGER.log(this + " is reset."),
                this._mediaSource &&
                    (this._sourceBuffer && (this._mediaSource.removeSourceBuffer(this._sourceBuffer), (this._sourceBuffer = null)), this._mediaSource.readyState === "open" && this._mediaSource.endOfStream(), (this._mediaSource = null)),
        ...
        (e.prototype.appendData = function (a) {
            ...
            this._sendRequest++, this._tempQueue.push({ method: "add", payload: a }), this._flushPayloads(), this._mediaPlayer && this._mediaPlayer.paused && this._mediaPlayer.play();
        }),
        (function () {
            function d(a) {
                var b = 0,
            ...
            if ($.event.fixHooks) for (var c = b.length; c; ) $.event.fixHooks[b[--c]] = $.event.mouseHooks;
        ...
        (WMKS.VNCDecoder = function (a) {
            ...
            return (
                ...
                this.options.backCanvas && ((this._canvas = this._canvas.concat([this.options.backCanvas])), (this._canvas[1].ctx = this.options.backCanvas.getContext("2d"))),
                this.options.blitTempCanvas && ((this._canvas = this._canvas.concat([this.options.blitTempCanvas])), (this._canvas[2].ctx = this.options.blitTempCanvas.getContext("2d"))),
                this.options.mediaPlayer && (this._mp4Decoder = new e()),
                typeof createImageBitmap != "undefined" ? ((this._useImageBitmaps = !0), (this._imageManager = null)) : (this._imageManager = new d(256)),
        ...
        (WMKS.VNCDecoder.prototype._receiveQueueConsumeBytes = function (a) {
            ...
            while (this._receiveQueueIndex > 0 && this._receiveQueue[0].data.byteLength <= this._receiveQueueIndex)
                (this._receiveQueueLength -= this._receiveQueue[0].data.byteLength), (this._receiveQueueIndex -= this._receiveQueue[0].data.byteLength), this._receiveQueue.shift();
        }),
            ...
            while (g < a)
                (b = h[g]),
                    b < 128
                        ...
                        : b < 240
                        ? ((c = h[g + 1] & 63), (d = h[g + 2] & 63), f.push(((b & 15) << 12) | (c << 6) | d), (g += 3))
                        : ((c = h[g + 1] & 63), (d = h[g + 2] & 63), (e = h[g + 3] & 63), f.push(((b & 7) << 18) | (c << 12) | (d << 6) | e), (g += 4));
        ...
        (WMKS.VNCDecoder.prototype._readUpdateCacheInitData = function (a) {
            "use strict", this._skipBytes(4), this._skipBytes(4), (a.updateCacheEntries = this._readInt16()), this._skipBytes(4), this._nextRect();
        }),
            ...
            if (a.cursorType === 0) {
                ...
                for (b = 0; b < a.height; b++)
                    for (c = 0; c < a.width; c++) {
                        ...
                        if (d[h * 4] === 255 && d[h * 4 + 1] === 255 && d[h * 4 + 2] === 255 && d[h * 4 + 3] === 255) for (var k = 0; k < 4; k++) e[h * 4 + k] !== 0 && ((e[h * 4 + k] = 0), (f[i] |= g));
                        else f[i] |= g;
                    }
        ...
        (WMKS.VNCDecoder.prototype._updateCanvasCursor = function () {
            var a, b;
            this._cursorVisible ? (WMKS.BROWSER.isIE() ? (a = "default") : (a = this._currentCursorURI)) : WMKS.BROWSER.isFirefox() && WMKS.BROWSER.isMacOS() ? (a = "none, !important") : (a = "none"),
        ...
        (WMKS.VNCDecoder.prototype._lighten = function (a, b, c, d, e) {
            "use strict", (this._canvas[0].ctx.globalCompositeOperation = "lighten"), (this._canvas[0].ctx.fillStyle = e), this._canvas[0].ctx.fillRect(a, b, c, d), (this._canvas[0].ctx.globalCompositeOperation = "source-over");
        }),
        ...
        (WMKS.VNCDecoder.prototype._readTightData = function (a) {
            ...
            a.subEncoding === this.subEncDiffJpeg && (b = this._decodeDiffComp(b, this._lastJpegData)),
                a.subEncoding !== this.subEncPNG ? ((this._lastJpegData = b), (f = "image/jpeg")) : (f = "image/png"),
                this._useImageBitmaps
                    ...
                    : ((a.image = this._imageManager.getImage()),
                      ...
                      d && !(WMKS.BROWSER.isChrome() && WMKS.BROWSER.version.major >= 50)
                          ? ((a.image.onload = this.onDecodeObjectURLComplete), (a.image.src = d.createObjectURL(new Blob([b], { type: f }))))
                          : ((b = c.encodeFromArray(b)), (a.image.onload = this.onDecodeComplete), (a.image.src = "data:" + f + ";base64," + b))),
                this._nextRect();
        }),
        ...
        (WMKS.VNCDecoder.prototype._readH264MP4Rect = function (a) {
            var b = this._readInt16(),
                c = this._readInt16(),
                d = this._readInt32();
            b === 1 && (WMKS.LOGGER.log("MP4 encoding is selected and stream is reset."), this.options.onEncodingChanged("MP4"), this._mp4Decoder.init(this._mediaPlayer, undefined, undefined, this.onDecodeComplete, this.onDecodeMP4Error)),
        ...
        (WMKS.VNCDecoder.prototype._evictUpdateCacheEntry = function (a) {
            "use strict", this.updateCache[a].image !== null && this._releaseImage(this.updateCache[a].image), (this.updateCache[a] = {}), (this.updateCache[a].image = null);
        }),
        ...
        (WMKS.VNCDecoder.prototype._executeUpdateCacheBegin = function (a) {
            ...
            do {
                ...
                if (c) for (e = 0; e < d && e < this.updateCacheEntries; e++) this._evictUpdateCacheEntry(e + f);
                f += d;
        ...
        (WMKS.VNCDecoder.prototype._executeUpdateCacheEnd = function (a) {
            ...
            do
                d == 0 && ((d = n.readEliasGamma()), (c = !c)),
                    (m = Math.min(k - i, g - e)),
                    (m = Math.min(m, d)),
                    c && (this._canvas[0].ctx.drawImage(b.image, i * 16, j * 16, m * 16, 16, e * 16, f * 16, m * 16, 16), (i += m), i == k && ((i = 0), j++)),
                    (e += m),
                    e == g && ((e = 0), f++),
                    (d -= m);
        ...
        (WMKS.VNCDecoder.prototype._executeUpdateCacheReplay = function (a) {
            ...
            do
                o == 0 && ((o = m.readEliasGamma()), (n = !n)),
                    ...
                    (f = d - b),
                    (f = Math.min(f, o)),
                    n && ((f = Math.min(f, j - h)), (f = Math.min(f, q)), p && this._canvas[0].ctx.drawImage(g.image, h * 16, i * 16, f * 16, 16, b * 16, c * 16, f * 16, 16), (h += f), h == j && ((h = 0), i++), (q -= f)),
                    (b += f),
                    b == d && ((b = 0), c++),
                    (o -= f);
        ...
        (WMKS.VNCDecoder.prototype._handleServerInitializedMsg = function () {
            ...
            var j = function () {
                (a._FBName = a._readString(i)),
                    ...
                    WMKS.LOGGER.log("Connected " + (a._encrypted ? "(encrypted)" : "(unencrypted)") + " to: " + a._FBName),
        ...
        (WMKS.VNCDecoder.prototype._sendClientCaps = function () {
            if (this._serverInitialized) {
                ...
                this.options.enableVorbisAudioClips ? (b |= this.clientCapVorbisAudioClips) : this.options.enableOpusAudioClips ? (b |= this.clientCapOpusAudioClips) : this.options.enableAacAudioClips && (b |= this.clientCapAacAudioClips),
                    ...
                    this.serverSupportsMKSVChanClipboard && this.vvcSession && (b |= this.clientCapUseMKSVChanClipboard),
                    a.push8(this.msgVMWClientMessage),
                    a.push8(3),
                    a.push16(8),
                    a.push32(b),
        ...
        (WMKS.VNCDecoder.prototype._handleServerCapsMsg = function () {
            ...
            (this.useVMWKeyEvent = !!(a & this.serverCapKeyEvent)),
                (this.allowVMWKeyEvent2UnicodeAndRaw = this.options.useUnicodeKeyboardInput && !!(a & this.serverCapKeyEvent2Unicode) && !!(a & this.serverCapKeyEvent2JSKeyCode)),
                ...
                this.useVMWRequestResolution && this.requestedWidth > 0 && this.requestedHeight > 0 && this.onRequestResolution(this.requestedWidth, this.requestedHeight),
        ...
        (WMKS.VNCDecoder.prototype._handleAudioMixer = function () {
            ...
            a < 2 && (b === 0 || b === 1)
                ...
                : WMKS.LOGGER.warn("Ignoring audio mixer message for an unsupported  channelId = " + a + " msgType = " + b + " data = " + c + " flags = " + d),
                this._getNextServerMessage();
        }),
        ...
        (WMKS.VNCDecoder.prototype._handleServerAudioMsgData = function (a) {
            a.length > 0
                ? ((a.data = this._readBytes(a.length)), this.useVMWAudioAck && (a.flags == 0 || a.flags & this.audioflagRequestAck) && this._sendAudioAck(a.audioTimestampLo, a.audioTimestampHi), this.options.onAudio(a))
        ...
        (WMKS.VNCDecoder.prototype.onRequestResolution = function (a, b) {
            this._serverInitialized &&
                ...
                ((this.resolutionRequestActive = !0), clearTimeout(this.resolutionTimer), (this.resolutionTimer = setTimeout(this.resolutionTimeout, this.resolutionDelay)), (this.requestedWidth = a), (this.requestedHeight = b));
        }),
        ...
        (WMKS.VNCDecoder.prototype.disconnect = function () {
            "use strict",
                this._state !== this.DISCONNECTED &&
                    ...
                    this._websocket &&
                        (this._sendSessionClose(23), (this._websocket.onopen = null), (this._websocket.onclose = null), (this._websocket.onmessage = null), (this._websocket.onerror = null), this._websocket.close(), delete this._websocket),
        ...
        (WMKS.VNCDecoder.prototype.connect = function (a) {
            ...
            this.setRenderCanvas(this.options.canvas),
                ...
                this.options.VCDProxyHandshakeVmxPath ? this._setReadCB(17, this._handleVCDProxyVmxPathMessage) : this._setReadCB(12, this._peekFirstMessage),
                (this._url = a),
                this._receiveQueueReset(),
                (this.wsOpen = function (a) {
                    ...
                    this.protocol === "vmware-vvc" && (b._setupVVC(), WMKS.LOGGER.log("WebSocket is using VMware Virtual Channels"), (this.protocol = "binary")),
                        this.protocol === "binary" && ((this.binaryType = "arraybuffer"), WMKS.LOGGER.log("WebSocket HAS binary support")),
                ...
                (this._retryConnectionTimeout = function () {
                    b._state === b.DISCONNECTED && (WMKS.LOGGER.log("Connection timeout. Retrying now."), b._websocket && ((b._websocket.onclose = function () {}), b._websocket.close(), (b._websocket = null)), b._setupConnection()),
                        (b._retryConnectionTimer = null);
                }),
                this.options.enableUint8Utf8 && f(this),
                this._setupConnection(),
                this.options.retryConnectionInterval > 0 &&
                    (WMKS.LOGGER.log("Check connection status after " + this.options.retryConnectionInterval + "ms."), (this._retryConnectionTimer = setTimeout(this._retryConnectionTimeout, this.options.retryConnectionInterval)));
        }),
        ...
        (WMKS.KeyboardManager = function (a) {
            ...
            (this._vncDecoder = a.vncDecoder),
                ...
                (this._windowsKeyManager = {
                    ...
                    keyboardHandler: function (a) {
                        a.keyCode === WMKS.CONST.KB.WindowsKeys.left || a.keyCode === 224
                            ? ((this.leftWindowsDown = a.type === "keydown"), this.leftWindowsDown || (this.windowsOn = !1))
                            : a.keyCode === WMKS.CONST.KB.WindowsKeys.right && ((this.rightWindowsDown = a.type === "keydown"), this.rightWindowsDown || (this.windowsOn = !1));
                    },
                ...
                (this._extractKeyCodeFromEvent = function (a) {
                    ...
                    if (a.keyCode)
                        (b = a.keyCode),
                            this.keyboardLayoutId == "pt-PT" && WMKS.BROWSER.isChrome() && (a.keyCode === 186 || a.keyCode === 191) && WMKS.BROWSER.isWindows() && (a.keyCode === 186 ? (b = 180) : (b = 126)),
                            this.keyboardLayoutId == "de-DE" && a.keyCode == 192 && WMKS.BROWSER.isFirefox() && (b = 187),
                            (this.keyboardLayoutId === "fr-CH" || this.keyboardLayoutId === "de-CH") && WMKS.BROWSER.isWindows() && a.keyCode === 221 && (b = 94);
                    ...
                    return !c && this._windowsKeyManager.enabled && (b = this._windowsKeyManager.modifyKey(b)), { keyCode: b, isUnicode: c };
                }),
                (this.onKeyDown = function (a) {
                    ...
                    var f = 0;
                    return (
                        WMKS.BROWSER.isFirefox() && WMKS.BROWSER.isMacOS() && a.altKey === !0 && a.ctrlKey === !0 && !this.allowVMWKeyEvent2UnicodeAndRaw ? (f = 1) : (f = 0),
                        (this.keyDownKeyTimer = setTimeout(function () {
                            e.sendKey(c, !1, !1), (e.keyDownKeyTimer = null), (e.pendingKey = null);
                        }, f)),
                        (this.pendingKey = c),
                        a.originalEvent && a.originalEvent.keyIdentifier && (this.keyDownIdentifier = a.originalEvent.keyIdentifier),
                        (a.returnValue =
                ...
                (this._syncModifiers = function (a) {
                    ...
                    for (d = 0; d < WMKS.CONST.KB.Modifiers.length; d++)
                        (b = WMKS.CONST.KB.Modifiers[d]),
                            ...
                            c && e === -1 ? (this.activeModifiers.push(b), this.sendKey(b, !1, !1)) : !c && e !== -1 && (this.activeModifiers.splice(e, 1), this.sendKey(b, !0, !1));
                }),
                    ...
                    if (this.fixANSIEquivalentKeys && a.originalEvent) {
                        if (a.originalEvent.key) h = a.originalEvent.key;
                            ...
                            a.originalEvent.keyIdentifier === "" && this.keyDownIdentifier
                                ...
                                : a.originalEvent.keyIdentifier && (h = String.fromCharCode(parseInt(a.originalEvent.keyIdentifier.replace("U+", ""), 16)));
                        h &&
                            ((f = h.charCodeAt(0) !== b),
                            (d = WMKS.CONST.KB.ANSIShiftSymbols.indexOf(h) !== -1 && this.activeModifiers.indexOf(WMKS.CONST.KB.KEY_CODE.Shift) === -1),
                            (e = WMKS.CONST.KB.ANSINoShiftSymbols.indexOf(h) !== -1 && this.activeModifiers.indexOf(WMKS.CONST.KB.KEY_CODE.Shift) !== -1),
                            (g = WMKS.CONST.KB.ANSISpecialSymbols.indexOf(h) !== -1));
                    }
                    return (
                        (this.keyDownIdentifier = null),
                        this.fixANSIEquivalentKeys && h && g && (f || d || e)
                            ? (e && this.sendKey(WMKS.CONST.KB.KEY_CODE.Shift, !0, !1), this.handleSoftKb(h.charCodeAt(0), !0), e && this.sendKey(WMKS.CONST.KB.KEY_CODE.Shift, !1, !1))
                            : (this._vncDecoder.allowVMWKeyEvent2UnicodeAndRaw || (b = this.handleInternationalKeyboard(a, b, this.pendingKey)),
                              this.pendingKey !== null && (c ? (this.keyToRawMap[this.pendingKey] = b) : (this.keyToUnicodeMap[this.pendingKey] = b)),
                              this.sendAndfixWrongKeys(a, b, c, this.pendingKey)),
                        ((this.pendingKey === 50 && b === 126) || (this.pendingKey === 55 && b === 96)) && !c && (WMKS.LOGGER.debug("Sending extra up for Unicode " + b + " so one isn't missed."), this.sendKey(b, !0, !c)),
                        (this.pendingKey = null),
                        !1
                    );
                }),
                (this.fixDeFrChSpecialKeys = function (a, b, c) {
                    return (
                        (this.keyboardLayoutId === "de-CH" || this.keyboardLayoutId === "fr-CH") &&
                            ...
                            (a.charCode === 176 && b === 176 ? ((a.keyCode = 1176), (a.charCode = 1176)) : a.charCode === 167 && b === 167 && ((a.keyCode = 1167), (a.charCode = 1167))),
                        a
                    );
                }),
                (this.sendAndfixWrongKeys = function (a, b, c, d) {
                    ...
                    if (e || f || h || g) {
                        ...
                        h && (this.sendKey(16, !0, !1), this.sendKey(b, !1, !c), this.sendKey(16, !1, !1)),
                            g && (this.sendKey(17, !1, !1), this.sendKey(18, !1, !1), this.sendKey(b, !1, !c), this.sendKey(17, !0, !1), this.sendKey(18, !0, !1));
                ...
                (this.remapUncontrolKey = function (a, b, c) {
                    ...
                    return d && (f !== undefined && (e = f[a.keyCode]), e !== undefined && ((c = !1), (b = e))), { keyCode: b, isRaw: c };
                }),
                (this.handleInternationalKeyboard = function (a, b, c) {
                    ...
                    switch (this.keyboardLayoutId) {
                        case "ja-JP_106/109":
                            ...
                            break;
                        case "de-DE":
                            (b == 123 || b == 124 || b == 125) && (d || WMKS.BROWSER.isFirefox) && WMKS.BROWSER.isWindows() && (b == 123 ? (b = 124) : b == 124 ? (b = 8804) : b == 125 && (b = 8800)),
                        ...
                        case "it-IT":
                            ...
                            break;
                        case "es-ES":
                            a.keyCode === 0 && WMKS.BROWSER.isFirefox() && (a.key == " " || a.key == "Dead") && a.charCode == 0 && a.which == 0 && (b = 222),
                                f && a.key == "\\" && WMKS.BROWSER.isWindows() && (b = 186),
                                (a.keyCode === 48 || a.keyCode === 34) && d && (b = a.keyCode + 1e3),
                                (b = this.getRemapPendingKey(b, c));
                            break;
                        case "pt-PT":
                            (b == 123 || b == 167) && (d || WMKS.BROWSER.isFirefox) && WMKS.BROWSER.isWindows() && (b == 123 ? (b = 55) : b == 167 && (b = 52)),
                                WMKS.BROWSER.isFirefox && WMKS.BROWSER.isWindows() && (a.key == "«" && (b = 187), a.key == "À" && (b = 333)),
                                a.keyCode == 192 && WMKS.BROWSER.isChrome && WMKS.BROWSER.isWindows() && (b = 333);
                            break;
                        case "fr-FR":
                            a.keyCode === 29 && WMKS.BROWSER.isChrome() && a.key != "€" && WMKS.BROWSER.isMacOS() && (b = 124), (b = this.getRemapPendingKey(b, c));
                            break;
                        case "fr-CH":
                        case "de-CH":
                            ...
                            WMKS.BROWSER.isWindows() && e && (b = this.getRemapFrChAltgrKey(b)),
                                ...
                                a.key === "À" && (a.keyCode || a.which) === 192 && this.keyboardLayoutId === "de-CH" && c !== 65 && (WMKS.BROWSER.isMacOS() || (WMKS.BROWSER.isFirefox() && WMKS.BROWSER.isWindows())) && (b = 1224),
                                (b = this.getRemapPendingKey(b, c));
                    }
                            ...
                            ? ((b = c.keyCode),
                              ...
                              b === 0
                                  ...
                                  : (this._handleCapsLockKey(b),
                                    f
                                        ? (WMKS.LOGGER.log("Sending unicode key up from keyIdentifier: " + b), this.sendKey(b, !0, !0))
                                        : this.keyToUnicodeMap.hasOwnProperty(b)
                                        ? ((d = this.keyToUnicodeMap[b]), this.sendKey(d, !0, !0), delete this.keyToUnicodeMap[b])
                ...
                (this.onInputTextSoftKb = function (a) {
                    ...
                    return WMKS.BROWSER.isIOS()
                        ...
                        : (d > 0 && (c = c.substring(d)),
                          c.length > 1 ? ((c = c.charAt(0).toLowerCase() + c.slice(1)), this.processInputString(c)) : WMKS.BROWSER.isAndroid() && WMKS.BROWSER.isChrome() && this.processInputString(c),
                    ...
                    (c = b && WMKS.CONST.KB.UnicodeWithShift[a]),
                        c
                            ? ((d = $.inArray(WMKS.CONST.KB.KEY_CODE.Shift, this.activeModifiers) !== -1),
                              !d && !this._isUnicodeInputSupported() && this.sendKey(WMKS.CONST.KB.KEY_CODE.Shift, !1, !1),
                              this.sendKey(a, !1, b),
                              this.sendKey(a, !0, b),
                              !d && !this._isUnicodeInputSupported() ? this.sendKey(WMKS.CONST.KB.KEY_CODE.Shift, !0, !1) : d && this._isUnicodeInputSupported() && this.sendKey(WMKS.CONST.KB.KEY_CODE.Shift, !1, !1))
        ...
        (WMKS.keyboardUtils._jsToVScanTables = {
            ...
            "it-IT": { 5: 18, 30: 26, 29: 27, 64: 39, 35: 40, 91: 26, 93: 27, 171: 27, 109: 39, 186: 39, 123: 26, 125: 27, 8364: 18 },
        }),
        (WMKS.keyboardUtils._charToKeycode = {
            "de-DE": { ü: 252, Ü: 252, ö: 246, Ö: 246, ä: 228, Ä: 228 },
            "es-ES": { "[": 192, "]": 43, "{": 222, "}": 231, 0: 186, '"': 1034, º: 186, ª: 186, ç: 231, Ç: 231, Ñ: 209, ñ: 209, "¡": 261, "¿": 161 },
            "it-IT": { "[": 30, "{": 30, "]": 29, "}": 29, "@": 1109, "%": 1037, à: 1224, "°": 1224, è: 232, é: 232, ì: 94, "^": 94, ò: 242, ç: 242, ù: 249, "§": 249 },
            "pt-BR": { ç: 231, Ç: 231 },
            "pt-PT": { ç: 231, Ç: 231, º: 186, ª: 186, "°": 43, "«": 187, "»": 187, À: 333 },
            "fr-FR": { "²": 178 },
            "fr-CH": { "§": 167, "°": 176, è: 232, ü: 252, é: 233, ö: 246, à: 1224, ä: 228, "[": 232, "{": 224, '"': 1224 },
            "de-CH": { "§": 167, "°": 176, è: 232, ü: 252, é: 233, ö: 246, à: 1224, ä: 228, "[": 232, "{": 224, '"': 1224, Ä: 228, Ö: 246, Ü: 252, À: 1224, È: 232, É: 233 },
        }),
        (WMKS.keyboardUtils._remapUncontrolKeys = { "de-DE": { 17: 81, 13: 77 }, "es-ES": { 27: 219 }, "it-IT": { 13: 186 }, "pt-PT": { 27: 168 }, "fr-FR": { 27: 93 }, "fr-CH": { 27: 232 }, "de-CH": { 27: 232 } }),
        ...
        (WMKS.keyboardUtils._smallKeyboardPendingKey = { "de-DE": { 47: 55, 61: 48 }, "fr-FR": { 43: [187, 61], 46: [190, 59], 47: [191, 58], 48: 48, 49: 49, 50: 50, 51: 51, 52: 52, 53: 53, 54: 54, 55: 55, 56: 56, 57: 57 } }),
        ...
        (WMKS.keyboardUtils._remapPending = {
            "fr-CH": { 224: 65, 232: 69, 233: 69, 228: 65, 246: 79, 252: 85, 192: 65, 219: 85, 241: 78, 209: 78, 176: 52, 167: 53 },
            "fr-FR": { 224: 65, 232: 69, 236: 73, 242: 79, 249: 85, 241: 78 },
            "de-CH": { 224: 65, 232: 69, 233: 69, 228: 65, 246: 79, 252: 85, 192: 65, 241: 78, 209: 78, 176: 52, 167: 53, 196: 65, 214: 79, 220: 85, 200: 69, 192: 65, 201: 69, 219: 85 },
            "de-DE": { 193: 65, 201: 69, 205: 73, 211: 79, 218: 85, 194: 65, 202: 69, 206: 73, 212: 79, 219: 85 },
            "ja-JP_106/109": { 92: 226 },
            "es-ES": { 193: 65, 201: 69, 205: 73, 211: 79, 218: 85, 192: 65, 200: 69, 204: 73, 210: 79, 217: 85, 241: 78 },
        }),
        ...
        (WMKS.CONST.TOUCH = {
            ...
            leftDragDelayMs: 300,
            OP: { none: "none", scroll: "scroll", drag: "drag", move: "move", tap_twice: "double-click", tap_1finger: "click", tap_3finger: "tap-3f" },
            SCROLL: { minDeltaDistancePx: 20 },
            DOUBLE_TAP: { tapGapInTime: 250, tapGapBonusTime: 200, tapGapBonus4TimeRatio: 0.4, tapGapInDistance: 40 },
        }),
        (WMKS.TouchHandler = function (a) {
            ...
            var b = a.widgetProto,
                ...
                g = a.onToggle,
                h = null,
                i = { currentTouchFingers: -1, firstTouch: null, currentTouch: null, touchArray: [], tapStartTime: null, touchMoveCount: 0, skipScrollCount: 0, scrollCount: 0, zoomCount: 0, opType: WMKS.CONST.TOUCH.OP.none },
                j = { inputProxy: null, cursorIcon: null, clickFeedback: null, dragFeedback: null, pulseFeedback: null, scrollFeedback: null, keypad: null, trackpad: null };
            (this._verifyQuickTouches = function (a, b, c) {
                ...
                (this._initTwoFingerTouch = function (a, b) {
                    i.opType === WMKS.CONST.TOUCH.OP.none &&
                        ((i.currentTouchFingers = 2), i.touchArray.push(a), i.touchArray.push(b), (i.firstTouch = WMKS.UTIL.TOUCH.copyTouch(WMKS.UTIL.TOUCH.leftmostOf(a, b))), (i.currentTouch = WMKS.UTIL.TOUCH.copyTouch(i.firstTouch)));
                }),
                ...
                (this._calculateMouseWheelDeltas = function (a, c) {
                    var d = 0,
                        ...
                        j;
                    return h && i && (g < f ? (i = !1) : (h = !1)), h && (d = a > 0 ? 1 : -1), i && (e = c > 0 ? -1 : 1), b.options.reverseScrollY && (e *= -1), { wheelDeltaX: d, wheelDeltaY: e };
                }),
                    ...
                    if (a.targetTouches.length === 1)
                        return (
                            this._isDoubleTap(a, f)
                                ? ((i.firstTouch = WMKS.UTIL.TOUCH.copyTouch(i.currentTouch)), (i.opType = WMKS.CONST.TOUCH.OP.tap_twice))
                                : ((i.firstTouch = WMKS.UTIL.TOUCH.copyTouch(a.targetTouches[0])), (i.currentTouch = WMKS.UTIL.TOUCH.copyTouch(a.targetTouches[0]))),
                        ...
                        return (
                            i.currentTouchFingers === 1 &&
                                ...
                                d > WMKS.CONST.TOUCH.additionalTouchIgnoreGapMs &&
                                    ...
                                    ((c = this._applyZoomCorrectionToTouchXY(a.targetTouches[0])), b.sendMouseButtonMessage(c, !0, WMKS.CONST.CLICK.left), this._resetTouchState())),
                            this._initTwoFingerTouch(WMKS.UTIL.TOUCH.copyTouch(a.targetTouches[0]), WMKS.UTIL.TOUCH.copyTouch(a.targetTouches[1])),
                            !0
                        );
                    ...
                    if (i.currentTouchFingers !== a.targetTouches.length) {
                        if (i.currentTouchFingers !== 2 || a.targetTouches.length !== 1)
                            return i.currentTouchFingers === 1 && a.targetTouches.length === 2
                                ? (WMKS.LOGGER.debug("touch: 1 -> 2, init 2fingertap if no opType: " + i.opType), this._initTwoFingerTouch(WMKS.UTIL.TOUCH.copyTouch(a.targetTouches[0]), WMKS.UTIL.TOUCH.copyTouch(a.targetTouches[1])), !0)
                                : (WMKS.LOGGER.debug("touch: 2 -> 1: infer as PINCH/ZOOM."), this._resetTouchState(), !0);
                        if (i.opType === WMKS.CONST.TOUCH.OP.none && a.scale === 1)
                            return WMKS.LOGGER.debug("touch: 2 -> 1 & !scroll, hence right-click."), this._sendTwoTouchEvent(i.firstTouch, i.firstTouch, WMKS.CONST.CLICK.right, a), this._resetTouchState(), !1;
                    } else {
                        if (i.currentTouchFingers === 1)
                            return (
                                ...
                                this._verifyQuickTouches(a, c, i.touchMoveCount)
                                    ? (this._initTwoFingerTouch(WMKS.UTIL.TOUCH.copyTouch(i.firstTouch), WMKS.UTIL.TOUCH.copyTouch(a.targetTouches[0])), (i.opType = WMKS.CONST.TOUCH.OP.scroll), !1)
                        ...
                        if (i.currentTouchFingers === 2 && i.opType === WMKS.CONST.TOUCH.OP.none) {
                            ...
                            if (e < 1 || e > 5.2) {
                                ...
                                if (i.scrollCount >= WMKS.CONST.TOUCH.touchMoveSampleMinCount)
                                    return (
                                        this._showFeedback(j.scrollFeedback, i.firstTouch, { position: "left", offsetLeft: -50, offsetTop: -25 }),
                        ...
                        switch (i.opType) {
                            ...
                            case WMKS.CONST.TOUCH.OP.drag:
                                return (
                                    (d = a.changedTouches),
                                    d.length === 1
                                        ? ((c = this._applyZoomCorrectionToTouchXY(d[0])), b.sendMouseButtonMessage(c, !1, WMKS.CONST.CLICK.left))
                                        : WMKS.LOGGER.warn("Unexpected touch# " + d.length + " changed in a drag operation!"),
                ...
                (this._sendTwoTouchEvent = function (a, c, d) {
                    ...
                    return (
                        ...
                        i.opType === WMKS.CONST.TOUCH.OP.tap_twice
                            ? (b.sendMouseButtonMessage(e, !1, d), this._showFeedback(j.clickFeedback, a, { showTwice: !0 }))
                            : ((e = this._applyZoomCorrectionToTouchXY(c)), b.sendMouseButtonMessage(e, !1, d), this._showFeedback(j.clickFeedback, a)),
                        !0
                    );
                }),
                    ...
                    return WMKS.BROWSER.isTouchDevice()
                        ? !a || a.is(":hidden")
                            ...
                            : ((b = a.width()),
                              ...
                              WMKS.UTIL.TOUCH.isPortraitOrientation() ? a.offset().left + b > e && (a.offset({ left: String(e - b - 5) }), (g = !0)) : a.offset().top + c > f && (a.offset({ top: String(f - c - 5) }), (g = !0)),
                              g)
                ...
                (this._showFeedback = function (a, b, c) {
                    ...
                    (e = g.offsetLeft || 0),
                        ...
                        a.css({ left: b.pageX + e + a.outerWidth() * d.width, top: b.pageY + f + a.outerHeight() * d.height }),
                ...
                (this.onCaretPositionChanged = function (a) {
                    var b, c;
                    j.inputProxy && ((b = a.x), (c = a.y), b < window.pageXOffset && (b = window.pageXOffset), c < window.pageYOffset && (c = window.pageYOffset), j.inputProxy.offset({ left: b, top: c }));
                }),
                ...
                (this.disconnectEvents = function () {
                    if (!f) return;
                    f.unbind("orientationchange.wmks.icons").unbind("orientationchange.wmks").unbind("touchmove.wmks").unbind("touchstart.wmks").unbind("touchend.wmks"),
                        f.find(".feedback-container").unbind("touchmove.wmks").unbind("touchstart.wmks").unbind("touchend.wmks");
                }),
                (this.initializeMobileFeature = function (a) {
                    ...
                    switch (a) {
                        ...
                        case WMKS.CONST.TOUCH.FEATURE.ExtendedKeypad:
                            (j.keypad = new WMKS.extendedKeypad({ widget: b, parentElement: f.parent(), keyboardManager: c })), j.keypad.initialize();
                            break;
        ...
        (WMKS.UTIL.TOUCH = {
            ...
            getRelativePositionMultiplier: function (a) {
                var b = -0.5,
                    c = -0.5;
                return !a || (a.indexOf("left") !== -1 ? (b = -1) : a.indexOf("right") !== -1 && (b = 1), a.indexOf("top") !== -1 ? (c = -1) : a.indexOf("bottom") !== -1 && (c = 1)), { width: b, height: c };
            },
            ...
            copyTouch: function (a) {
                var b = { screenX: a.screenX, screenY: a.screenY, clientX: a.clientX, clientY: a.clientY, pageX: a.pageX, pageY: a.pageY };
                return b;
            },
        ...
        (WMKS.widgetProto.getCanvasPosition = function (a, b) {
            ...
            return (
                this.options.useNativePixels ? ((e = Math.ceil(this._canvas.width() * d) - 1), (f = Math.ceil(this._canvas.height() * d) - 1)) : ((e = Math.ceil(this._canvas.width()) - 1), (f = Math.ceil(this._canvas.height()) - 1)),
                (g = Math.min(g, e)),
                (h = Math.min(h, f)),
                (g = Math.max(g, 0)),
                (h = Math.max(h, 0)),
                ...
                return (
                    c.which
                        ? WMKS.BROWSER.isMacOS() && WMKS.BROWSER.isGecko() && c.ctrlKey && c.button === 2
                            ? (WMKS.LOGGER.trace("FF on OSX: Rewrite Ctrl+Right-click as Ctrl+Left-click."), (e = 1))
                            : (e = 1 << c.button)
        ...
        (WMKS.widgetProto.sendMouseButtonMessage = function (a, b, c) {
            return (
                this._vncDecoder &&
                    (b ? (this._mouseDownBMask |= c) : (this._mouseDownBMask &= ~c), (this._mousePosGuest.x !== a.x || this._mousePosGuest.y !== a.y) && this.sendMouseMoveMessage(a), this._vncDecoder.onMouseButton(a.x, a.y, b, c)),
                !0
            );
        }),
        ...
        (WMKS.widgetProto.disconnectEvents = function () {
            this.element.unbind("contextmenu.wmks").unbind("keydown.wmks").unbind("keypress.wmks").unbind("keyup.wmks").unbind("mousedown.wmks").unbind("mousewheel.wmks"),
        ...
        (WMKS.widgetProto.updateTopology = function (a) {
            ...
            for (b = 0; b < a.length; b++)
                (a[b].left = a[b].left * this._pixelRatio), (a[b].top = a[b].top * this._pixelRatio), (a[b].requestedWidth = a[b].requestedWidth * this._pixelRatio), (a[b].requestedHeight = a[b].requestedHeight * this._pixelRatio);
        ...
        (WMKS.widgetProto.rescaleOrResize = function (a) {
            ...
            this._canvas.css({ width: this._guestWidth / this._pixelRatio, height: this._guestHeight / this._pixelRatio });
            ...
            if (this.transform !== null) {
                ...
                if (c !== this._x || d !== this._y) (this._x = c), (this._y = d), this._canvas.css({ top: d, left: c });
            }
        }),
        ...
        (WMKS.widgetProto._create = function () {
            ...
            (this._mouseDownBMask = 0),
                ...
                this.options.enableMP4 && ((this._video = WMKS.UTIL.createVideo(!0)), this.element.append(this._video));
            var b = function (b) {
                return typeof a._canvas[0].style[b] != "undefined" ? b : null;
            };
            (this.transform = b("transform") || b("WebkitTransform") || b("MozTransform") || b("msTransform") || b("OTransform")),
                (this._vncDecoder = new WMKS.VNCDecoder({
                    ...
                    onEncodingChanged: function (b) {
                        b === "TightPNG" && !a.isCanvasActive
                            ? (WMKS.LOGGER.info("Activate canvas element since we use TightPNG encoding."), (a.isCanvasActive = !0), a._video && a._video.hide(), a._canvas.show())
                            : b === "MP4" && a.isCanvasActive
                            ? (WMKS.LOGGER.info("Activate video element since we use MP4 encoding."), a._video ? ((a.isCanvasActive = !1), a._canvas.hide(), a._video.show()) : WMKS.LOGGER.error("Video element doesn't exist."))
                            : b === "RawH264" && a.isCanvasActive && WMKS.LOGGER.info("Activate video element since we use raw H264 encoding.");
                    },
                ...
                this._updateMobileFeature(this.options.allowMobileKeyboardInput, WMKS.CONST.TOUCH.FEATURE.SoftKeyboard),
                this._updateMobileFeature(this.options.allowMobileTrackpad, WMKS.CONST.TOUCH.FEATURE.Trackpad),
                this._updateMobileFeature(this.options.allowMobileExtendedKeypad, WMKS.CONST.TOUCH.FEATURE.ExtendedKeypad);
        }),
        (function () {
            "use strict",
                (WMKS.dialogManager = function () {
                    (this.dialog = null), (this.visible = !1), (this.lastToggleTime = 0), (this.options = { name: "DIALOG_MGR", toggleCallback: function (a, b) {}, minToggleTime: 50 });
                }),
            ...
            "use strict",
                ...
                (WMKS.extendedKeypad.prototype.positionFunctionKeys = function () {
                    ...
                    if (a.is(":visible")) {
                        ...
                        var e;
                        d
                            ? ((e = parseInt(b.css("z-index"), 10) - 1), $("#fnKeyInnerBorder").css("border-color", "#d5d5d5"))
                            : ((e = parseInt($("#ctrlPaneWidget").css("z-index"), 10) + 1), $("#fnKeyInnerBorder").css("border-color", "#aaa")),
                ...
                (WMKS.extendedKeypad.prototype.adjustFunctionKeyStyle = function (a) {
                    var b = $("#fnKeyPad"),
                        c = b.find(".key-group");
                    a
                        ? c.hasClass("down-position") && (c.removeClass("down-position"), c.addClass("up-position"), b.removeClass("fnKey-pane-wrapper-down"), b.addClass("fnKey-pane-wrapper"))
                        : c.hasClass("up-position") && (c.removeClass("up-position"), c.addClass("down-position"), b.removeClass("fnKey-pane-wrapper"), b.addClass("fnKey-pane-wrapper-down"));
                });
        })(),
        (function () {
            "use strict",
                ...
                (WMKS.trackpadManager = function (a, b) {
                    WMKS.dialogManager.call(this),
                        ...
                        (this.history = []),
                        $.extend(this.options, { name: "TRACKPAD", speedControlMinMovePx: 5, accelerator: 10, minSpeed: 1, maxSpeed: 10 }),
                ...
                (WMKS.trackpadManager.prototype.create = function () {
                    ...
                    return !this._widget || !this._canvas
                        ? (WMKS.LOGGER.debug("Trackpad dialog creation has been aborted. Widget or Canvas is not ready."), null)
                ...
                (WMKS.trackpadManager.prototype.trackpadClickStart = function (a, b) {
                    return b !== WMKS.CONST.CLICK.left && b !== WMKS.CONST.CLICK.right
                        ...
                        : ($(a.target).addClass("button-highlight"), this._widget.sendMouseButtonMessage(this.getMousePosition(), !0, b), !1);
                }),
                (WMKS.trackpadManager.prototype.trackpadClickEnd = function (a, b) {
                    return b !== WMKS.CONST.CLICK.left && b !== WMKS.CONST.CLICK.right
                        ? (WMKS.LOGGER.debug("assert: unknown button " + b), !1)
                        : ($(a.target).removeClass("button-highlight"), this._widget.sendMouseButtonMessage(this.getMousePosition(), !1, b), !1);
                }),
                (WMKS.trackpadManager.prototype.computeMovingDistance = function (a, b) {
                    ...
                    return (
                        ...
                        f > this.options.maxSpeed ? (f = this.options.maxSpeed) : f < this.options.minSpeed && (f = this.options.minSpeed),
                        [c * f, d * f]
                    );
                }),
                    ...
                    return (
                        a.targetTouches.length > 2
                            ? this.state === WMKS.CONST.TRACKPAD.STATE.scroll
                                ? WMKS.LOGGER.debug("Ignore new touchstart, currently scrolling, touch#: " + a.targetTouches.length)
                                : (WMKS.LOGGER.debug("Aborting touch, too many fingers #: " + a.targetTouches.length), this.resetTrackpadState())
                            : a.targetTouches.length === 2
                    ...
                    return (
                        ...
                        this.state === WMKS.CONST.TRACKPAD.STATE.idle
                            ...
                            : ((b = a.targetTouches[0].pageX),
                              ...
                              c < e.offset().top || c > e.offset().top + e.height() || b < e.offset().left || b > e.offset().left + e.width()
                                  ? (this.state === WMKS.CONST.TRACKPAD.STATE.drag &&
                                        (this._dragStartedByLongTap && f.sendMouseButtonMessage(this.getMousePosition(), !1, WMKS.CONST.CLICK.left), (this.state = WMKS.CONST.TRACKPAD.STATE.tap), (this.history.length = 0)),
                                    !1)
                                  : (this.state === WMKS.CONST.TRACKPAD.STATE.drag
                                        ? ((d = this.computeNewCursorLocation(b, c)), !f._touchHandler || f._touchHandler.moveCursor(d.x, d.y), f.sendMouseMoveMessage(d), this.history.shift(), this.history.push({ x: b, y: c }))
                                        : this.state === WMKS.CONST.TRACKPAD.STATE.scroll && this.sendScrollMessageFromTrackpad(a.targetTouches[0]),
                                    this.state === WMKS.CONST.TRACKPAD.STATE.tap
                                        ? ((this.state = WMKS.CONST.TRACKPAD.STATE.drag), this.history.push({ x: b, y: c }, { x: b, y: c }, { x: b, y: c }))
                                        : this.state === WMKS.CONST.TRACKPAD.STATE.tap_2finger && a.targetTouches.length === 2 && ((this.state = WMKS.CONST.TRACKPAD.STATE.scroll), (this.history[0] = { x: b, y: c })),
                                    !1))
                    );
                }),
                (WMKS.trackpadManager.prototype.computeNewCursorLocation = function (a, b) {
                    ...
                    return (
                        ...
                        isNaN(c) || c === 0
                            ? d
                            : (c < this.options.speedControlMinMovePx ? ((d.x += a - this.history[2].x), (d.y += b - this.history[2].y)) : ((c = this.computeMovingDistance(a, b)), (d.x += Math.floor(c[0])), (d.y += Math.floor(c[1]))),
                    ...
                    return (
                        ...
                        a.targetTouches.length !== 0 || this.state === WMKS.CONST.TRACKPAD.STATE.idle
                            ...
                            : ((b = this.getMousePosition()),
                              this.state === WMKS.CONST.TRACKPAD.STATE.tap
                                  ? (this._widget.sendMouseButtonMessage(b, !0, WMKS.CONST.CLICK.left), this._widget.sendMouseButtonMessage(b, !1, WMKS.CONST.CLICK.left))
                                  : this.state === WMKS.CONST.TRACKPAD.STATE.tap_2finger
                                  ? (this._widget.sendMouseButtonMessage(b, !0, WMKS.CONST.CLICK.right), this._widget.sendMouseButtonMessage(b, !1, WMKS.CONST.CLICK.right))
                                  : this.state === WMKS.CONST.TRACKPAD.STATE.drag && this._dragStartedByLongTap && this._widget.sendMouseButtonMessage(b, !1, WMKS.CONST.CLICK.left),
    ...
    (g.ENABLE_PROBE_CHANNEL = 1),
        ...
        (g.STATUS = { SUCCESS: 0, ERROR: 1, OUT_OF_MEMORY: 2, INVALID_ARGS: 3, INVALID_STATE: 4, CLOSED: 5, PROTOCOL_ERROR: 6, TRANSPORT_ERROR: 7, OPEN_REJECTED: 8, OPEN_TIMEOUT: 9 }),
            ...
            return a instanceof m
                ? a.state === g.SESSION_STATE.CLOSING
                    ...
                    : ((b = this._sessions.indexOf(a)),
                      b === -1
                          ? (this.setLastError(g.STATUS.INVALID_ARGS, "VVC.closeSession", "Invalid session, session is not registered with this vvc instance"), !1)
                          : (a.onSessionClose(), (this._sessions = this._sessions.splice(b, 1)), !0))
                : (this.setLastError(g.STATUS.INVALID_ARGS, "VVC.closeSession", "Invalid session, not instanceof VVCSession"), !1);
        }),
        (g.prototype.createListener = function (a, b) {
            var c, d, e;
            if (a instanceof m) {
                if (b.length < g.MIN_CHANNEL_NAME_LEN || b.length > g.MAX_CHANNEL_NAME_LEN)
                    return this.setLastError(g.STATUS.INVALID_ARGS, "VVC.createListener", 'Invalid name "' + b + '",' + " length must be between " + g.MIN_CHANNEL_NAME_LEN + " and " + g.MAX_CHANNEL_NAME_LEN + " characters."), null;
        ...
        (g.prototype.closeListener = function (a) {
            ...
            return a instanceof k
                ? a.state === g.LISTENER_STATE.CLOSING
                    ? !0
                    : b === -1
                    ? (this.setLastError(g.STATUS.INVALID_ARGS, "VVC.closeListener", "Invalid listener, listener is not registered with this vvc instance"), !1)
                    : (a.onclose && a.onclose(), (this._listeners = this._listeners.splice(b, 1)), !0)
                : (this.setLastError(g.STATUS.INVALID_ARGS, "VVC.closeListener", "Invalid listener, not instanceof VVCListener"), !1);
        }),
    ...
    (g.CHANNEL_STATE = { INIT: 0, OPEN_FAILED: 1, OPEN: 2, CLOSING: 3, PEER_CLOSING: 4, PEER_CLOSED: 5, CLOSED: 6 }),
    ...
    (j.prototype = Object.create(i.prototype)),
        ...
        (g.CTRL_OP = { RECV_ACK: 1, INIT: 2, INIT_ACK: 3, OPEN_CHAN: 4, OPEN_CHAN_ACK: 5, OPEN_CHAN_CANCEL: 6, CLOSE_CHAN: 7, CLOSE_CHAN_ACK: 8, RTT: 9, RTT_ACK: 10 }),
        ...
        (j.prototype.sendInit = function (a) {
            ...
            if (g.MAJOR_VER >= 2) {
                ...
                for (c = 0; c < g.SUPPORTED_VER.length; ++c)
                    d.writeUint16(g.INIT_EXT_TYPE.VERSION), d.writeUint16(g.INIT_EXT_FLAG.EDAT), d.writeUint32(8), d.writeUint16(g.SUPPORTED_VER[c].MAJOR), d.writeUint16(g.SUPPORTED_VER[c].MINOR), d.writeUint32(g.SUPPORTED_VER[c].FLAGS);
        ...
        (j.prototype.sendOpenChannel = function (a, b) {
            ...
            return a instanceof i
                ...
                : (this._vvcInstance.setLastError(g.STATUS.INVALID_ARGS, "VVCControlChannel.sendOpenChannel", "Invalid channel,  expected instanceof VVCChannel"), !1);
        }),
        ...
        (j.prototype._isVersionSupported = function (a, b) {
            ...
            for (var c = 0; c < g.SUPPORTED_VER.length; ++c) if (g.SUPPORTED_VER[c].MAJOR == a && g.SUPPORTED_VER[c].MINOR == b) return !0;
            return !1;
        }),
        (j.prototype._onInit = function (a, b) {
                ...
                while (a.bytesRemaining() >= 8) {
                    ...
                    switch (j) {
                        case g.INIT_EXT_TYPE.VERSION:
                            ...
                            (n = a.readUint16()), (o = a.readUint16()), (p = a.readUint32()), h.push({ major: n, minor: o });
                            break;
            ...
            else for (var s = 0; s < h.length; s++) (n = h[s].major), (o = h[s].minor), this._isVersionSupported(n, o) && n >= this.versionMajor && o >= this.versionMinor && ((this.versionMajor = n), (this.versionMinor = o));
            return this.versionMajor == 0 && this.versionMinor == 0
                ? (this._vvcInstance.setLastError(g.STATUS.PROTOCOL_ERROR, "VVCControlChannel._onInit", "Failed to negotiate compatible protocol  version."), !1)
                : (b === g.CTRL_OP.INIT && this.sendInit(g.CTRL_OP.INIT_ACK), this._session.onConnect(), !0);
        }),
            ...
            return this._checkErrorMinimumSize(g.CTRL_OP.OPEN_CHAN_ACK, a)
                ? ((b = a.readUint32()),
                  ...
                  this._checkErrorMinimumSize(g.CTRL_OP.OPEN_CHAN_ACK, a, d)
                      ? ((e = a.readArray(d)), this._checkErrorValidChannel(g.CTRL_OP.OPEN_CHAN_ACK, b, g.CHANNEL_STATE.INIT) ? (this._session.onChannelOpen(this._session.getChannel(b), c, e), !0) : !1)
                      : !1)
                : !1;
        }),
        (j.prototype._onCloseChannel = function (a) {
            ...
            return this._checkErrorMinimumSize(g.CTRL_OP.CLOSE_CHAN, a)
                ? ((b = a.readUint32()), (c = a.readUint32()), this._checkErrorValidChannel(g.CTRL_OP.CLOSE_CHAN, b) ? (this._session.onChannelClose(this._session.getChannel(b), c), !0) : !1)
                : !1;
        }),
        (j.prototype._onCloseChannelAck = function (a) {
            var b, c;
            return this._checkErrorMinimumSize(g.CTRL_OP.CLOSE_CHAN_ACK, a)
                ? ((b = a.readUint32()), (c = a.readUint32()), this._checkErrorValidChannel(g.CTRL_OP.CLOSE_CHAN_ACK, b, g.CHANNEL_STATE.CLOSING) ? (this._session.onChannelClose(this._session.getChannel(b), c), !0) : !1)
                : !1;
        }),
        ...
        (j.prototype._checkErrorSessionState = function (a, b) {
            ...
            return this._session.state !== b
                ? (this._session.onSessionError(g.STATUS.PROTOCOL_ERROR, "VVCControlChannel._checkErrorSessionState", "Received invalid " + c + " message, " + "invaild session state, " + "found " + this._session.state + " expected " + b),
                  !1)
                : !0;
        }),
        (j.prototype._checkErrorValidChannel = function (a, b, c) {
            ...
            return b === g.CONTROL_CHANNEL_ID
                ? (this._session.onSessionError(g.STATUS.PROTOCOL_ERROR, "VVCControlChannel._checkErrorValidChannel", "Received invalid " + d + " message, " + "unexpected use of control channel id"), !1)
                : e
                ? c !== undefined && e.state !== c
                    ? (this._session.onSessionError(g.STATUS.PROTOCOL_ERROR, "VVCControlChannel._checkErrorValidChannel", "Received invalid " + d + " message, " + "unexpected channel state, " + "found " + e.state + " " + " expected " + c),
                      !1)
                    : !0
                : (this._session.onSessionError(g.STATUS.PROTOCOL_ERROR, "VVCControlChannel._checkErrorValidChannel", "Received invalid " + d + " message, " + "unknown channel " + b), !1);
        }),
        (j.prototype._createControlPacket = function (a, b, c) {
            var d = WMKS.Packet.createNewPacket();
            return (c = c || 0), (b = b || 0), (d.control = { code: a, flags: b, param: c }), d.writeUint8(a), d.writeUint8(b), d.writeUint16(c), d;
        }),
    ...
    var m = function (a, b) {
        ...
        return (
            ...
            (this._buffers.header = WMKS.Packet.createNewPacket(g.CHUNK_COMMON_HEADER_SIZE + g.CHUNK_LARGE_HEADER_SIZE + g.CHUNK_EXTENSION_HEADER_SIZE)),
    ...
    (g.CHUNK_COMMON_HEADER_SIZE = 4),
        ...
        (g.SESSION_RECEIVE_STATE = { COMMON_HEADER: 0, LARGE_HEADER: 1, EXTENSION_HEADER: 2, EXTENSION_DATA: 3, DATA: 4 }),
                ...
                this._checkErrorNameLength("openChannel", a)
                    ? this._checkErrorSessionState("openChannel", g.SESSION_STATE.ESTABLISHED)
                        ? this._checkErrorInitialData("openChannel", e)
                            ? ((f = this.createChannel(this._nextChannelId(), a, b, c, d)), this.controlChannel.sendOpenChannel(f, e), f)
                            : null
                        : null
                    : null
            );
                ...
                this._checkErrorSessionState("acceptChannel", g.SESSION_STATE.ESTABLISHED)
                    ? this._checkErrorInitialData("acceptChannel", c)
                        ? this._checkErrorIsChannel("acceptChannel", a)
                            ? (this.controlChannel.sendOpenChannelAck(a, g.OPEN_CHAN_STATUS.SUCCESS, c), this.onChannelOpen(a, g.OPEN_CHAN_STATUS.SUCCESS, a.initialData), delete a.initialData, a)
                            : null
                        : null
                    : null
            );
                ...
                this._checkErrorSessionState("rejectChannel", g.SESSION_STATE.ESTABLISHED)
                    ? this._checkErrorInitialData("rejectChannel", b)
                        ? this._checkErrorIsChannel("rejectChannel", a)
                            ? (this.controlChannel.sendOpenChannelAck(a, g.OPEN_CHAN_STATUS.REJECT, b), (a.state = g.CHANNEL_STATE.CLOSED), this._releaseChannel(a), !0)
                            : !1
                        : !1
                    : !1
            );
            ...
            return this._checkErrorSessionState("closeChannel", g.SESSION_STATE.ESTABLISHED)
                ? this._checkErrorIsChannel("closeChannel", a)
                    ? this._checkErrorChannelState("closeChannel", a, g.CHANNEL_STATE.OPEN)
                        ? ((a.state = g.CHANNEL_STATE.CLOSING), this.controlChannel.sendCloseChannel(a, g.CLOSE_CHAN_REASON.NORMAL), !0)
                        : !1
                    : !1
                : !1;
        }),
        ...
        (m.prototype.onChannelOpen = function (a, b, c) {
            b === g.OPEN_CHAN_STATUS.SUCCESS ? ((a.state = g.CHANNEL_STATE.OPEN), a.onopen && a.onopen(this._createEvent("open", { data: c }))) : ((a.state = g.CHANNEL_STATE.OPEN_FAILED), this._releaseChannel(a), this.onChannelError(a));
        }),
        ...
        (m.prototype.onChannelClose = function (a, b) {
            ...
            b === g.CLOSE_CHAN_REASON.NORMAL
                ? ((c = 1e3), a.state === g.CHANNEL_STATE.CLOSING ? (a.state = g.CHANNEL_STATE.PEER_CLOSED) : ((a.state = g.CHANNEL_STATE.PEER_CLOSING), this.controlChannel.sendCloseChannelAck(a, g.CLOSE_CHAN_STATUS.SUCCESS)))
                : (c = 1002),
                a.onclose && a.onclose(this._createEvent("close", { wasClean: b === g.CLOSE_CHAN_REASON.NORMAL, reason: b, code: c })),
                ...
                case g.SESSION_RECEIVE_STATE.EXTENSION_HEADER:
                    (this._chunk.ext.code = b.readUint8()),
                        ...
                        this._chunk.ext.flags & g.CHUNK_EXT_FLAG.EDAT
                            ? ((this._chunk.ext.length = this._chunk.ext.param + 1), (this._buffers.ext = new WMKS.Packet.createNewPacket(this._chunk.ext.length)), this._setReceiveState(g.SESSION_RECEIVE_STATE.EXTENSION_DATA))
                            : ((this._chunk.ext.length = 0), this._chunk.ext.flags & g.CHUNK_EXT_FLAG.ELST ? this._setReceiveState(g.SESSION_RECEIVE_STATE.DATA) : this._setReceiveState(g.SESSION_RECEIVE_STATE.EXTENSION_HEADER));
                    break;
                case g.SESSION_RECEIVE_STATE.EXTENSION_DATA:
                    this._chunk.ext.code == g.CHUNK_EXT_CODE.LARGE_CHANNEL_ID && b.bytesRemaining() >= 4 && (this._chunk.channel = b.readUint32()),
                        (this._buffers.ext = null),
                        this._chunk.ext.flags & g.CHUNK_EXT_FLAG.ELST ? this._setReceiveState(g.SESSION_RECEIVE_STATE.DATA) : this._setReceiveState(g.SESSION_RECEIVE_STATE.EXTENSION_HEADER);
                    break;
                case g.SESSION_RECEIVE_STATE.DATA:
                    this._chunk.flags & g.CHUNK_FLAG.FIN &&
                        ((b = this._combineBuffers(this._buffers.data[this._chunk.channel])), this.onChannelMessage(this._channels[this._chunk.channel], b), (this._buffers.data[this._chunk.channel] = [])),
                        this._setReceiveState(g.SESSION_RECEIVE_STATE.COMMON_HEADER);
            }
        ...
        (m.prototype.send = function (a, b) {
            ...
            if (b instanceof Uint8Array || b instanceof ArrayBuffer) {
                (c = this._buffers.send),
                    ...
                    (e = b.byteLength),
                    (d = g.CHUNK_FLAG.FIN),
                    e > g.CHUNK_MAX_LEN ? (c.writeUint8(g.CHUNK_FLAG.LC | d), c.writeUint16(0), c.writeUint32(e - 1)) : (c.writeUint8(d), c.writeUint16(e - 1));
                try {
        ...
        (m.prototype._checkErrorNameLength = function (a, b) {
            return b.length < g.MIN_CHANNEL_NAME_LEN || b.length > g.MAX_CHANNEL_NAME_LEN
                ? (this._vvcInstance.setLastError(g.STATUS.INVALID_ARGS, "VVCSession." + a, "Invalid name " + b + " length must be between " + g.MIN_CHANNEL_NAME_LEN + " and " + g.MAX_CHANNEL_NAME_LEN + " bytes"), !1)
                : !0;
        }),
        (m.prototype._checkErrorInitialData = function (a, b) {
            return !b || b instanceof Uint8Array
                ? b && b.length > g.MAX_INITIAL_DATA_LEN
                    ? (this._vvcInstance.setLastError(g.STATUS.INVALID_ARGS, "VVCSession." + a, "Invalid initial data, must be smaller than " + g.MAX_INITIAL_DATA_LEN + " bytes"), !1)
                    : !0
                : (this._vvcInstance.setLastError(g.STATUS.INVALID_ARGS, "VVCSession." + a, "Invalid initial data, must be instanceof Uint8Array"), !1);
        }),
        (WMKS.RelativeMouseHandler = function (a) {
            ...
            var b = a.widgetProto,
                c = a.canvas,
                d = a.onToggle,
                e = { inputProxy: null, cursorIcon: null, clickFeedback: null, dragFeedback: null, pulseFeedback: null, scrollFeedback: null, keypad: null, relativePad: null };
            ...
            "use strict",
                ...
                (WMKS.relativePadManager = function (a, b) {
                    WMKS.dialogManager.call(this),
                        ...
                        (this.history = []),
                        $.extend(this.options, { name: "RELATIVEPAD", speedControlMinMovePx: 5, accelerator: 10, minSpeed: 1, maxSpeed: 10 }),
                ...
                (WMKS.relativePadManager.prototype.relativepadMouseMove = function (a) {
                    ...
                    return this.state === WMKS.CONST.RELATIVEPAD.STATE.idle
                        ...
                        : ((b = a.pageX),
                          (c = a.pageY),
                          c < f.offset().top || c > f.offset().top + f.height() || b < f.offset().left || b > f.offset().left + f.width()
                              ? (this.state === WMKS.CONST.RELATIVEPAD.STATE.move && ((this.state = WMKS.CONST.RELATIVEPAD.STATE.idle), (this.history.length = 0)), !1)
                              : (this.state === WMKS.CONST.RELATIVEPAD.STATE.move &&
                                    ((d = this.computeNewCursorLocation(b, c)),
                                    WMKS.VNCDecoder.cursorPosition && ((e = this._widget.getRelativeMouseCanvasPosition(WMKS.VNCDecoder.cursorPosition)), g._relativeMouseHandler.moveCursor(e.x, e.y)),
                                    g.sendMouseMoveMessage(d),
                                    this.history.shift(),
                                    this.history.push({ x: b, y: c })),
                                this.state === WMKS.CONST.RELATIVEPAD.STATE.click && ((this.state = WMKS.CONST.RELATIVEPAD.STATE.move), this.history.push({ x: b, y: c }, { x: b, y: c }, { x: b, y: c })),
                                !1));
                }),
                (WMKS.relativePadManager.prototype.computeNewCursorLocation = function (a, b) {
                    ...
                    return (
                        ...
                        isNaN(c) || c === 0
                            ? d
                            : (c < this.options.speedControlMinMovePx ? ((d.x = a - this.history[2].x), (d.y = b - this.history[2].y)) : ((c = this.computeMovingDistance(a, b)), (d.x = Math.floor(c[0])), (d.y = Math.floor(c[1]))), d)
                    );
                }),
                ...
                (WMKS.relativePadManager.prototype.relativepadMouseClick = function (a, b) {
                    ...
                    var c = a || window.event,
                        ...
                        e;
                    return (
                        c.which ? (c.which == 1 ? (e = 1) : c.which == 2 ? (e = 4) : c.which == 3 && (e = 2)) : c.button == 0 ? (e = 1) : c.button == 1 ? (e = 4) : c.button == 2 && (e = 2),
        ...
        $.extend(WMKS.CONST, {
            ...
            (WMKS.CoreWMKS = function (a) {
                ...
                var h = function (a) {
                        ...
                        (c.wmks[0].style.cssText = "position:fixed; margin:0px; left:0px; top:0px; height:" + window.innerHeight + "px;" + "width:" + window.innerWidth + "px;"),
                            c.wmksData.rescaleOrResize(!0),
                            d(WMKS.CONST.Events.FULL_SCREEN_CHANGE, a, { isFullScreen: !0 });
                    },
                    i = function (a) {
                        $(window).off("resize.wmks", h), (c.wmks[0].style.cssText = c.oldCssText), c.wmksData.rescaleOrResize(!0), $(window).off("resize.wmks", i), d(WMKS.CONST.Events.FULL_SCREEN_CHANGE, a, { isFullScreen: !1 });
                    };
